...
async function recreateDB(){
 ...
 let instance2 = new vehicle({vehicle_name:"Car",vehicle_size:6,vehicle_type:"Sedan"});
  instance2.save( function(err,doc) {
  if(err) return console.error(err);
  console.log("Second vehicle details saved")
  });
  let instance3 = new vehicle({vehicle_name:"Van",vehicle_size:8,vehicle_type:"Trucks"});
